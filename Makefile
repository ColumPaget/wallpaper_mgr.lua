...
wallpaper_mgr:
	cat common.lua settings.lua blocklist.lua sources.lua html.lua playlist.lua bing.lua nasa.lua esa.lua chandra.lua hip_wallpaper.lua localfiles.lua wallpapers13.lua getwallpapers.lua wallpaper_access.lua suwalls.lua hdqwalls.lua wallpaperscraft.lua wikimedia.lua archive_org.lua ssh.lua xsetroot.lua download.lua resolution.lua pigeonholed.lua help.lua main.lua > wallpaper_mgr.lua
